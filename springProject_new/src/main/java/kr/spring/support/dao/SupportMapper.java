...
public interface SupportMapper {
	...
	@Insert("INSERT INTO support (num,m_num,p_num,g_num,d_num,support_amount,gift_option,donation) VALUES (#{num},#{m_num},#{p_num},#{g_num},#{d_num},#{support_amount},#{gift_option},#{donation})")
	...
	@Select("SELECT support_seq.nextval FROM dual")
